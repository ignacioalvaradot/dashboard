...
const color = d3.scaleOrdinal(d3.schemeCategory10);
      useEffect(() => {
       ...
       .style('background-color','white');
          ...
          .data(dataExp.fase[dataExp.experimento.faseActiva].idGrupos[props.data].participantes)
          .join("circle")
            .attr("cx", function(d,i){ return 50 + d.dispositivos[0].canal*80})
        ...
        svg.selectAll("mylabels")
          .data(dataExp.fase[dataExp.experimento.faseActiva].idGrupos[props.data].participantes)
          .join("text")
            .attr("x", function(d,i){ return 30 + d.dispositivos[0].canal*80})
