  ...
  useEffect(() => {
    ...
    path
      ...
      .on('mouseover', (e,d)=>{
        ...
        //.text("El número de intervenciones <br> es de" +  d.data.numeroInterv)
        .html(dataExp.fase[dataExp.experimento.faseActiva].idGrupos[props.grupos].participantes[d.index].descripcion +" tiene: "+ d.data.numeroInterv +" <br>intervenciones<br> y " + Math.round(d.data.totalTimeInterv) + " tiempo total<br> de intervenciones" )
      })
      .on('mousemove',(e,d) => {
        tooldiv.style('top',(e.pageY - 150) + 'px')
